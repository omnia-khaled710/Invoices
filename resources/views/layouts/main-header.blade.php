                        ...
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                  <a href="{{route('MarkReadAll')}}">تعين قراءه الكل</a> </span>
                                  </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                               <h6 id="notifications_count">  لديك عدد
                                {{ auth()->user()->unreadNotifications->count() }} اشعارات غير مقروءة</h6>
                            </p>
                        </div>
                        <div id="unreadNotifications" class="main-notification-list Notification-scroll">
                            @foreach (auth()->user()->unreadNotifications as $notification)
                                <a class="d-flex p-3 border-bottom"
                                    href="{{ url('readNotification', $notification->data['ID']) }}">
                                    ...
                                    <div class="mr-3">
                                        <h5 class="notification-label mb-1">
                                            {{ $notification->data['title'] }} <br>{{ $notification->data['user'] }}
                                        </h5>
