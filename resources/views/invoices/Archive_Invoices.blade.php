                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td><a
                                                href="{{ url('ArchivedInvoicesDetails') }}/{{ $invoice->id }}">{{ $invoice->invoice_number }}</a>
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href="{{ url('ArchivedInvoicesDetails') }}/{{ $invoice->id }}"><i
                                                            class="text-warning fas fa-file-alt"></i>&nbsp;&nbsp; تفاصيل
                                                        الفاتورة</a>
