            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        @can('اضافة منتج')
                            <a class="btn ripple btn-primary" data-target="#exampleModal" data-toggle="modal"
                                href="">اضافة
                                منتج</a>
                        @endcan
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->Section->sectionName }}</td>
                                        ...
                                        <td>
                                            @can('تعديل منتج')
                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                    ...
                                                    data-sectionid="{{ $product->sectionID }}"
                                            ...
                                            @can('حذف منتج')
                                                <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                    data-id="{{ $product->id }}"
                                                    data-productname="{{ $product->productName }}" data-toggle="modal"
                ...
                <div class="modal-body">
                    <form action="products/update" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <label for="recipient-name" class="col-form-label">اسم المتنج:</label>
